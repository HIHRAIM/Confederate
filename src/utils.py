...
_LOCALE = {
    ...
    "help": {
        ...
        "cmd_remadmin": {
            "ru": "/remadmin <user> — убрать Bridge Admin",
            "uk": "/remadmin <user> — видалити Bridge Admin",
            "pl": "/remadmin <user> — usuń Bridge Admin",
            "en": "/remadmin <user> — remove a Bridge Admin",
            "es": "/remadmin <user> — eliminar un Bridge Admin",
            "pt": "/remadmin <user> — remover um Bridge Admin",
        },
        "cmd_unverify": {
            "ru": "/unverify <user> — отозвать верификацию пользователя",
            "uk": "/unverify <user> — скасувати верифікацію користувача",
            "pl": "/unverify <user> — cofnij weryfikację użytkownika",
            "en": "/unverify <user> — revoke a user's verification",
            "es": "/unverify <user> — revocar la verificación de un usuario",
            "pt": "/unverify <user> — revogar a verificação de um usuário",
        },
        "cmd_allow_bots": {
            "ru": "/allow-bots enable|disable — разрешить или запретить пересылку сообщений от ботов",
            "uk": "/allow-bots enable|disable — дозволити або заборонити пересилання повідомлень від ботів",
            "pl": "/allow-bots enable|disable — zezwolić lub zabronić przekazywania wiadomości od botów",
            "en": "/allow-bots enable|disable — allow or block relay of bot messages",
            "es": "/allow-bots enable|disable — permitir o bloquear el relay de mensajes de bots",
            "pt": "/allow-bots enable|disable — permitir ou bloquear o relay de mensagens de bots",
        },
        "cmd_allow_bots_tg": {
            "ru": "/allow_bots enable|disable — разрешить или запретить пересылку сообщений от ботов",
            "uk": "/allow_bots enable|disable — дозволити або заборонити пересилання повідомлень від ботів",
            "pl": "/allow_bots enable|disable — zezwolić lub zabronić przekazywania wiadomości od botów",
            "en": "/allow_bots enable|disable — allow or block relay of bot messages",
            "es": "/allow_bots enable|disable — permitir o bloquear el relay de mensajes de bots",
            "pt": "/allow_bots enable|disable — permitir ou bloquear o relay de mensagens de bots",
        },
        "cmd_deadchat": {
